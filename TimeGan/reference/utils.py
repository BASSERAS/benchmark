...
# Patch missing TF1 APIs
for _name in ['Session', 'placeholder', 'reset_default_graph', 'get_variable',
              'variable_scope', 'set_random_seed', 'global_variables_initializer',
              'trainable_variables', 'losses', 'AUTO_REUSE']:
...
if not hasattr(tf, 'contrib'):
    ...
    try: tf.contrib.rnn.LayerNormBasicLSTMCell = _lstm_cell
    except: pass
