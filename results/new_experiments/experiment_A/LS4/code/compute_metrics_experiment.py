...
Usage:
  CUDA_VISIBLE_DEVICES=2 python compute_metrics_experiment.py --experiment A --source model --seeds 5
  CUDA_VISIBLE_DEVICES=2 python compute_metrics_experiment.py --experiment A --source floor --seeds 5
"""
import os
import sys
import argparse
...
METHOD_DIR = os.path.dirname(HERE)                                  # .../LS4
...
def load_generated(seed):
    if args.source == "model":
        ...
        hint = f"Run train_ls4_experiment.py --seed {seed} first."
    else:
