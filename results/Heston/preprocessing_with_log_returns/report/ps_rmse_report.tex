...
Recomputing every RMSE row under both aggregations, \textbf{7 of the 10 cum/step rows
...
separates the top three generators. At the 1M bank the cum RMSE values are $0.049253$, $0.048875$, $0.048944$ for CSDI, TimeDiT (raw)
and LS4 --- a spread of $3.8\times10^{-4}$ --- while each 95\% bootstrap CI
is about $6.3\times10^{-3}$ wide, 17$\times$ larger.
...
square root is enough to reshuffle it. Only SBTS (13\% worse) and, more weakly, the two forecasters separate from the
pack at all.
...
\end{tabular}
\end{center}
\noindent\textbf{Winners (of 18 ranked rows = 6 ranked metrics $\times$ 3 quantities):} TimeDiT (raw) 15 $\cdot$ SBTS 2 $\cdot$ CSDI 1.
\end{landscape}
\begin{landscape}
...
\end{tabular}
\end{center}
\noindent\textbf{Winners (of 18 ranked rows = 6 ranked metrics $\times$ 3 quantities):} TimeDiT (raw) 15 $\cdot$ CSDI 1 $\cdot$ LS4 1 $\cdot$ SBTS 1.
\end{landscape}
\begin{landscape}
...
\end{tabular}
\end{center}
\noindent\textbf{Winners (of 18 ranked rows = 6 ranked metrics $\times$ 3 quantities):} TimeDiT (raw) 14 $\cdot$ CSDI 2 $\cdot$ LS4 2.
\end{landscape}
\begin{landscape}
...
\end{tabular}
\end{center}
\noindent\textbf{Winners (of 18 ranked rows = 6 ranked metrics $\times$ 3 quantities):} TimeDiT (raw) 15 $\cdot$ CSDI 2 $\cdot$ LS4 1.
\end{landscape}
\begin{landscape}
...
\end{tabular}
\end{center}
\noindent\textbf{Winners (of 18 ranked rows = 6 ranked metrics $\times$ 3 quantities):} TimeDiT (raw) 15 $\cdot$ LS4 2 $\cdot$ CSDI 1.
\end{landscape}
\clearpage
\section{Figures}
