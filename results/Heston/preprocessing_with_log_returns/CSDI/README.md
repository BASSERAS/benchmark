...
**Cumulative return (trajectory, u = 1…H)** — CSDI+logret vs Heston-oracle ceiling vs RW floor

| metric | CSDI+logret | Heston oracle | RW floor |
|--------|:----------:|:-------------:|:--------:|
| RMSE (textbook) | 0.04925 [0.04612, 0.05242] | **0.04911** [0.04599, 0.05209] | 0.05670 [0.05332, 0.05993] |
| CRPS | 0.02544 [0.02395, 0.02695] | **0.02525** [0.02380, 0.02668] | 0.02946 [0.02778, 0.03112] |
| coverage 50 | 0.4624 [0.4388, 0.4866] | **0.4891** [0.4658, 0.5133] | 0.4719 [0.4456, 0.4999] |
| coverage 90 | 0.8682 [0.8505, 0.8864] | **0.8941** [0.8776, 0.9103] | 0.8553 [0.8359, 0.8746] |
| width 50 | 0.05285 [0.05163, 0.05397] | 0.05719 [0.05587, 0.05841] | 0.06286 [0.06169, 0.06405] |
| width 90 | 0.1348 [0.1320, 0.1374] | 0.1465 [0.1432, 0.1494] | 0.1520 [0.1490, 0.1548] |
| lower-miss 90 | 0.07599 [0.06177, 0.09174] | **0.05463** [0.04254, 0.06787] | 0.08331 [0.06781, 0.09924] |
| upper-miss 90 | 0.05579 [0.04333, 0.06818] | **0.05127** [0.03924, 0.06366] | 0.06134 [0.04724, 0.07605] |
...
| CRPS | 0.006767 [0.006566, 0.006983] | **0.006750** [0.006553, 0.006961] | 0.006874 [0.006680, 0.007082] |
| coverage 50 | 0.4532 [0.4420, 0.4646] | 0.4816 [0.4705, 0.4934] | **0.5157** [0.5029, 0.5283] |
| coverage 90 | 0.8640 [0.8559, 0.8718] | 0.8864 [0.8791, 0.8936] | **0.8866** [0.8784, 0.8943] |
| width 50 | 0.01338 [0.01309, 0.01365] | 0.01449 [0.01416, 0.01480] | 0.01602 [0.01566, 0.01637] |
| width 90 | 0.03550 [0.03482, 0.03612] | 0.03815 [0.03738, 0.03886] | 0.03968 [0.03895, 0.04039] |
| lower-miss 90 | 0.07062 [0.06537, 0.07593] | **0.05725** [0.05261, 0.06213] | 0.05933 [0.05426, 0.06445] |
| upper-miss 90 | 0.06543 [0.06140, 0.06958] | 0.05634 [0.05249, 0.06036] | **0.05408** [0.04950, 0.05884] |

**Horizon realized vol (scalar) — the diagnostic quantity**

| metric | CSDI+logret | Heston oracle | RW floor |
|--------|:----------:|:-------------:|:--------:|
| MAE | 0.01373 [0.01280, 0.01471] | **0.01291** [0.01213, 0.01380] | 0.01509 [0.01415, 0.01599] |
| RMSE (true, root-last)† | 0.01772 [0.01660, 0.01895] | **0.01625** [0.01523, 0.01732] | 0.01876 [0.01764, 0.01984] |
| CRPS | 0.009938 [0.009288, 0.01064] | **0.009143** [0.008611, 0.009735] | 0.01168 [0.01085, 0.01248] |
| coverage 50 | **0.4746** [0.4316, 0.5176] | 0.4727 [0.4277, 0.5137] | 0.2344 [0.1973, 0.2715] |
| coverage 90 | 0.8633 [0.8340, 0.8926] | **0.9238** [0.9004, 0.9453] | 0.5332 [0.4922, 0.5762] |
| width 50 | 0.02115 [0.02094, 0.02136] | 0.02217 [0.02190, 0.02241] | 0.01202 [0.01175, 0.01231] |
| width 90 | 0.05138 [0.05087, 0.05184] | 0.05411 [0.05350, 0.05473] | 0.02873 [0.02811, 0.02937] |
| lower-miss 90 | 0.01758 [0.007812, 0.02930] | **0.02930** [0.01562, 0.04492] | 0.2891 [0.2480, 0.3301] |
| upper-miss 90 | 0.1191 [0.09180, 0.1465] | **0.04688** [0.02930, 0.06641] | 0.1777 [0.1445, 0.2109] |

**Reading it.** On **cumulative and one-step return CSDI+logret sits *on* the oracle ceiling** — cum
RMSE 0.04925 vs 0.04911 and CRPS 0.0254 vs 0.0252 with fully overlapping CIs; step is a three-way tie
(RMSE 0.01245 / 0.01244 / 0.01253). CSDI's return-level forecasting is statistically indistinguishable from the
...
Terminal (h=H) **MAE** 0.0521 is a genuine single-horizon diagnostic, **distinct** from the
horizon-averaged cumulative RMSE 0.04925. It is a *mean absolute* error: the driver computes it as
`mean_q |·|` (`path_shadowing_pdf.py`), so despite the JSON key still being named `terminal_rmse` it
is the h = H analogue of the rv MAE row above, **not** the textbook RMSE. The CSDI RV mean bias (−0.0065) is **3× the oracle's
