...
|--------|:----------:|:-------------:|:--------:|
| RMSE (textbook) | **0.04888** [0.04586, 0.05181] | 0.04911 [0.04599, 0.05209] | 0.05670 [0.05332, 0.05993] |
| CRPS | **0.02521** [0.02382, 0.02660] | 0.02525 [0.02380, 0.02668] | 0.02946 [0.02778, 0.03112] |
| coverage 50 | **0.5072** [0.4831, 0.5319] | 0.4891 [0.4658, 0.5133] | 0.4719 [0.4456, 0.4999] |
| coverage 90 | **0.8983** [0.8826, 0.9144] | 0.8941 [0.8776, 0.9103] | 0.8553 [0.8359, 0.8746] |
| width 50 | 0.05901 [0.05774, 0.06015] | 0.05719 [0.05587, 0.05841] | 0.06286 [0.06169, 0.06405] |
| width 90 | 0.1486 [0.1456, 0.1514] | 0.1465 [0.1432, 0.1494] | 0.1520 [0.1490, 0.1548] |
| lower-miss 90 | **0.04572** [0.03460, 0.05713] | 0.05463 [0.04254, 0.06787] | 0.08331 [0.06781, 0.09924] |
| upper-miss 90 | 0.05597 [0.04327, 0.06897] | **0.05127** [0.03924, 0.06366] | 0.06134 [0.04724, 0.07605] |

**One-step return (trajectory, u = 1…H)**

| metric | TimeDiT raw | Heston oracle | RW floor |
|--------|:----------:|:-------------:|:--------:|
| RMSE (textbook) | 0.01246 [0.01211, 0.01284] | **0.01244** [0.01210, 0.01282] | 0.01253 [0.01218, 0.01290] |
| CRPS | 0.006760 [0.006563, 0.006971] | **0.006750** [0.006553, 0.006961] | 0.006874 [0.006680, 0.007082] |
| coverage 50 | 0.4761 [0.4651, 0.4873] | 0.4816 [0.4705, 0.4934] | **0.5157** [0.5029, 0.5283] |
| coverage 90 | 0.8806 [0.8735, 0.8878] | 0.8864 [0.8791, 0.8936] | **0.8866** [0.8784, 0.8943] |
| width 50 | 0.01428 [0.01396, 0.01458] | 0.01449 [0.01416, 0.01480] | 0.01602 [0.01566, 0.01637] |
| width 90 | 0.03758 [0.03683, 0.03826] | 0.03815 [0.03738, 0.03886] | 0.03968 [0.03895, 0.04039] |
| lower-miss 90 | 0.05884 [0.05414, 0.06354] | **0.05725** [0.05261, 0.06213] | 0.05933 [0.05426, 0.06445] |
| upper-miss 90 | 0.06061 [0.05652, 0.06458] | 0.05634 [0.05249, 0.06036] | **0.05408** [0.04950, 0.05884] |

**Horizon realized vol (scalar) — the diagnostic quantity**

| metric | TimeDiT raw | Heston oracle | RW floor |
|--------|:----------:|:-------------:|:--------:|
| MAE | 0.01295 [0.01215, 0.01386] | **0.01291** [0.01213, 0.01380] | 0.01509 [0.01415, 0.01599] |
| RMSE (true, root-last)† | 0.01637 [0.01536, 0.01745] | **0.01625** [0.01523, 0.01732] | 0.01876 [0.01764, 0.01984] |
| CRPS | 0.009179 [0.008621, 0.009797] | **0.009143** [0.008611, 0.009735] | 0.01168 [0.01085, 0.01248] |
| coverage 50 | **0.4883** [0.4453, 0.5312] | 0.4727 [0.4277, 0.5137] | 0.2344 [0.1973, 0.2715] |
| coverage 90 | **0.8945** [0.8691, 0.9219] | 0.9238 [0.9004, 0.9453] | 0.5332 [0.4922, 0.5762] |
| width 50 | 0.02155 [0.02129, 0.02178] | 0.02217 [0.02190, 0.02241] | 0.01202 [0.01175, 0.01231] |
| width 90 | 0.05213 [0.05159, 0.05261] | 0.05411 [0.05350, 0.05473] | 0.02873 [0.02811, 0.02937] |
| lower-miss 90 | **0.03125** [0.01758, 0.04688] | 0.02930 [0.01562, 0.04492] | 0.2891 [0.2480, 0.3301] |
| upper-miss 90 | 0.07422 [0.05269, 0.09766] | **0.04688** [0.02930, 0.06641] | 0.1777 [0.1445, 0.2109] |
...
Terminal (h=H) **MAE** 0.0522 is a *mean absolute* error — the driver computes it as `mean_q |·|`
(`path_shadowing_pdf.py`), so despite the JSON key still being named `terminal_rmse` it is the h = H
analogue of the rv MAE row above, **not** the textbook RMSE (horizon-averaged cum RMSE is 0.04888).
