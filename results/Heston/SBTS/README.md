...
|----|--------|-----------|--------|--------|--------|--------|--------|---------------|
| | **— Fat Tail —** | | | | | | | |
| A10 | Kurtosis Error         | 0.1187 ± 0.0060 | 0.1156 | 0.1116 | 0.1165 | 0.1293 | 0.1203 | 0.0000 |
...
| | **— Distribution —** | | | | | | | |
| A1  | Path MMD²              | 0.0112 ± 0.0011 | 0.0129 | 0.0120 | 0.0104 | 0.0100 | 0.0105 | 0.0015 |
| A2  | Terminal MMD²          | 0.0102 ± 0.0014 | 0.0113 | 0.0097 | 0.0085 | 0.0092 | 0.0124 | 0.0016 |
| A3  | Increment MMD²         | 0.0069 ± 0.0005 | 0.0067 | 0.0066 | 0.0069 | 0.0063 | 0.0077 | 0.0007 |
| A4  | Volatility MMD         | 0.2964 ± 0.0126 | 0.2970 | 0.2873 | 0.2968 | 0.2821 | 0.3188 | 0.0071 |
| A5  | Terminal SWD           | 3.7097 ± 0.3209 | 4.1147 | 3.6846 | 3.6757 | 3.1564 | 3.9169 | 0.687  |
| A6  | Path SWD               | 2.5335 ± 0.2212 | 2.8445 | 2.6110 | 2.5826 | 2.1668 | 2.4625 | 0.438  |
...
| | **— Adversarial —** | | | | | | | |
| A13 | Disc Score GRU        | 0.2740 ± 0.2208 | 0.0005 | 0.4286 | 0.4643 | 0.4689 | 0.0078 | 0.008 |
| A13 | Disc Score MLP        | 0.0063 ± 0.0038 | 0.0029 | 0.0014 | 0.0084 | 0.0121 | 0.0066 | 0.010 |
| | **— Predictive —** | | | | | | | |
| A14 | Pred Score GRU (TSTR) | 0.0586 ± 0.0000 | 0.0586 | 0.0586 | 0.0585 | 0.0586 | 0.0586 | 0.054 |
| A14 | Pred Score MLP (TSTR) | 0.0582 ± 0.0002 | 0.0584 | 0.0579 | 0.0584 | 0.0581 | 0.0582 | 0.054 |
| | **— Temporal —** | | | | | | | |
| A7  | Covariance Error       | 145.35 ± 4.89   | 143.74 | 145.83 | 142.90 | 139.93 | 154.36 | 0.00   |
| A11 | ACF \|r\| Error        | 0.0596 ± 0.0005 | 0.0601 | 0.0595 | 0.0596 | 0.0587 | 0.0599 | 0.0000 |
| A12 | ACF r² Error           | 0.0619 ± 0.0005 | 0.0625 | 0.0618 | 0.0614 | 0.0612 | 0.0624 | 0.0000 |
...
| | **— Vol —** | | | | | | | |
| A8  | Mean RMSE              | 1.3013 ± 0.2776 | 1.2972 | 0.9199 | 1.4819 | 1.0986 | 1.7088 | 0.000  |
| A9  | Return Std Error       | 0.2492 ± 0.0018 | 0.2503 | 0.2517 | 0.2485 | 0.2491 | 0.2462 | 0.0000 |
| A16 | Log-Return Std Error   | 0.0030 ± 0.0000 | 0.0030 | 0.0030 | 0.0030 | 0.0030 | 0.0030 | 0.0000 |
| A19 | Kurtosis Ratio (→ 1)   | 1.9890 ± 0.0182 | 1.9907 | 1.9978 | 1.9877 | 2.0121 | 1.9569 | 1.0000 |
...
| | **— Heston Spec —** | | | | | | | |
| A15 | Sigma Corr ↑          | 0.0046 ± 0.0019 | 0.0046 | 0.0045 | 0.0016 | 0.0048 | 0.0074 | 0.614  |
| A15 | Sigma RMSE            | 0.0955 ± 0.0001 | 0.0955 | 0.0955 | 0.0957 | 0.0954 | 0.0954 | 0.065  |
| A21 | Oracle Sigma Corr ↑   | 0.0046 ± 0.0019 | 0.0046 | 0.0045 | 0.0016 | 0.0048 | 0.0074 | 0.614  |
...
tail-survival ≈ 0, near-zero ACF lags) — this is a property of the curve, not a bug.
...
| **Rolling vol histogram**| MSE   | 1227.3 ± 5.1 | 1234.2 | 1226.4 | 1231.0 | 1223.2 | 1221.8 | 0.0 |
