...
def _cell(blk):
    ...
    method row, which is the sample sd ACROSS THE 4 SEEDS. One is sampling noise
...
on the bold **{METHOD}** row it is the sample **sd across the {n_crps_seeds} seeds** (training +
