...
> beats the RW baseline but does **not** beat LS4 PS-MC (**2.704 / 3.763**). See the
> [Chronos-2 forecaster reference](#chronos-2--forecaster-reference-not-a-generator) below and
