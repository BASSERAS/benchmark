...
construction and only an entropy-penalised volatility correction is learned on top. Two of the nine wins
(A11, A18-MLP) sit **below the Perfect-Recovery Floor**, which flags an under-dispersed sample rather than
superiority, corroborated by its weak tail rows (A5 5.110 vs floor 0.5266, A28 1.182 vs floor 1.006). Read the
...
A19-MLP **0.05006**, at or under the finite-sample floor). The remaining families defend narrow niches.
