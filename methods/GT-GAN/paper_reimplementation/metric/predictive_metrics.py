...
#     methods/GT-GAN/code/reference/metrics/predictive_metrics.py
# which itself is the TimeGAN post-hoc predictive score (Yoon et al.,
# NeurIPS'19) as vendored by the GT-GAN authors (Jeon et al., NeurIPS'22).
#
# GTGAN_stocks.py scores with `predictive_score_metrics2` (the univariate-target
# TSTR variant: train a 1-layer GRU on synthetic to predict the last channel,
# report MAE on real). Both functions are kept verbatim for auditability.
# TensorFlow 1.x — will NOT run on this CUDA-13 box; see ../README.md §"caveat".
# ---------------------------------------------------------------------------
